...
export default function Footer() {
    return (
        <>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.587052145531!2d77.17092367641182!3d28.64213607565954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d029f5692b10f%3A0x57d3c924a8d28e13!2sArena%20Animation%20Patel%20Nagar%2C%20Delhi%20-%20Best%20Institute%20for%20Animation%2C%20VFX%2C%20Gaming%2C%20Graphics%20and%20Web%20Courses!5e0!3m2!1sen!2sin!4v1767440140154!5m2!1sen!2sin" width="100%" height="400" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            <footer className="bg-neutral-primary-soft">
                <div className="mx-auto w-full container p-4 py-6 lg:py-8">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-body sm:text-center">© 2026 Arena Animation Patel Nagar. All Rights Reserved.
                        </span>
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            <a href="https://www.instagram.com/arenaanimationpatelnagar/" className="h-5.5 w-5.5">
